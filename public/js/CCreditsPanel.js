function CCreditsPanel() {
  ...
  this._init = function () {
    ...
    _oMsgTextOutline = new createjs.Text(
    ...
    oSprite = s_oSpriteLibrary.getSprite("logo");
    _oButLogo = createBitmap(oSprite);
    _oButLogo.regX = oSprite.width / 5;
    _oButLogo.regY = oSprite.height / 5;
    _oButLogo.x = CANVAS_WIDTH / 5;
    _oButLogo.y = CANVAS_HEIGHT / 5;
    _oContainer.addChild(_oButLogo);

    _oLinkOutline = new createjs.Text(
      // "www.codethislab.com",
      "34px " + FONT_GAME,
      "#000"
    );
