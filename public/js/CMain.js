function CMain(oData) {
  ...
  function depositMoney(amount) {
    var currentMoney = s_oGame.getMoney();
    s_oGame.setMoney(currentMoney + amount);
  }
  ...
  this._loadImages = function () {
    ...
    s_oSpriteLibrary.addSprite("but_profile", "./sprites/but_profile.png");
    s_oSpriteLibrary.addSprite("but_login", "./sprites/but_login.png");

    for (var i = 1; i < NUM_SYMBOLS + 1; i++) {
      s_oSpriteLibrary.addSprite(
        "symbol_" + i,
        "./sprites/symbol_" + i + ".png"
      );
      s_oSpriteLibrary.addSprite(
        "symbol_" + i + "_anim",
